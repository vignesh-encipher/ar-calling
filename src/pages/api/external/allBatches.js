export default async function handler(req, res) {
  ...
  try {
    console.log('=== BACKEND API HANDLER START ===');
    ...
    console.log('Target URL: https://ar.encipherhealth.com/ar/allBatches');
    
    console.log('About to make fetch request...');
    const response = await fetch('https://ar.encipherhealth.com/ar/allBatches', {
      method: 'GET',
      headers: {
    ...
    if (!contentType || !contentType.includes('application/json')) {
      ...
      if (responseText.includes('ngrok') || responseText.includes('ERR_NGROK')) {
        ...
        return res.status(500).json({
          ...
          message: 'Please authenticate with ngrok tunnel first. Using local data as fallback.'
        });
      }
    ...
    console.log('=== BACKEND API DEBUG END ===');
    ...
    console.error('=== BACKEND API ERROR END ===');
